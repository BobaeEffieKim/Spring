...
<body>
   ...
   <footer>
      <div id="footer">
         ...
         <div id="address">
            <address>
               <span class="bold">(주)예담직업전문학교</span> 
               대구광역시 중구 중앙대로 403 (남일동 135-1, 5층) 
            ...
            <p>
               ...
               <span class="colorCCC">/</span> <span class="bold">개인정보보호책임자</span>:서강중(ask@yedam.ac)
            </p>
            <p>
               Copyright &copy; 2009 <span>(주)예담직업전문학교</span> All Rights Reserved.
            </p>
         </div>
      </div>
   </footer>
